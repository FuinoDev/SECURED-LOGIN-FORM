...
import { createAdminUser, createAgent, createPasswordResetForUser, fetchCsrf, loginUser, registerUser, resetDatabase, TEST_PASSWORD, WEAK_PASSWORD, } from "./helpers.js";
...
describe("session security", () => {
    ...
    it("logs out and clears access", async () => {
        ...
        await registerUser(agent, csrf, { email }).expect(201);
        const login = await loginUser(agent, csrf, email).expect(200);
        const nextCsrf = login.body.csrfToken;
